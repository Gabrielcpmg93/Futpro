...
import { Star, Play, ArrowRight, ArrowLeft, Zap, Activity } from 'lucide-react';
...
const CareerView: React.FC<CareerViewProps> = ({ onComplete, onCancel, onWinTrophy }) => {
    ...
    return (
        <div className="min-h-screen bg-violet-900 text-white flex flex-col">
            {step === 1 && (
                <div className="flex-1 flex flex-col items-center justify-center p-6 animate-in zoom-in">
                    <div className="w-full max-w-sm">
                        <h2 className="text-3xl font-bold text-center mb-2 text-yellow-400">Modo Carreira</h2>
                        <p className="text-center text-violet-300 mb-8">Inicie sua jornada rumo ao estrelato.</p>
                        ...
                        <button onClick={handleCreate} className="w-full bg-yellow-400 hover:bg-yellow-300 text-violet-900 font-bold py-4 rounded-xl transition-colors shadow-lg shadow-yellow-400/20 text-lg mb-4">
                            Iniciar Carreira
                        </button>
                        <button onClick={onCancel} className="w-full text-violet-400 text-sm font-medium py-2 hover:text-white transition-colors">Cancelar</button>
                    </div>
                </div>
            )}
                ...
                <div className="flex-1 flex flex-col bg-slate-900 text-white animate-in fade-in">
                    ...
                    <div className="p-6 bg-gradient-to-b from-violet-900 to-slate-900 pb-10">
                         <div className="flex items-center gap-4 mb-6">
                             ...
                             <div className="w-16 h-16 bg-violet-700 rounded-xl flex items-center justify-center border-2 border-white/20 font-bold text-2xl">
                                 {playerName.charAt(0)}
                             </div>
