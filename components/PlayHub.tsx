...
const PlayHub: React.FC<PlayHubProps> = ({ team, onNavigate }) => {
  return (
    <div className="p-6 pb-24 animate-in fade-in duration-500 min-h-screen bg-slate-50">
      ...
      <div className="space-y-4">
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-start">
                ...
                <h2 className="text-2xl font-bold mb-1">Partida Oficial</h2>
                <p className="text-slate-400 text-sm mb-4">Jogue com o {team.name} e ganhe recompensas.</p>
      ...
      <div className="mt-8 bg-yellow-50 p-4 rounded-2xl border border-yellow-100 flex items-start gap-3">
          ...
          <div>
              ...
              <p className="text-yellow-700 text-xs mt-1">Jogar partidas oficiais aumenta o orçamento do clube. Amistosos são ótimos para testar táticas!</p>
          </div>
      </div>
    </div>
  );
